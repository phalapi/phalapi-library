...
$appKey = '8w7jv4qb8f41y';
$appSecret = '2b1do42Hsta';
$jsonPath = "jsonsource/";
...
//	echo ("\n***************** user **************\n");
	...
	// 刷新用户信息方法
	$result = $RongCloud->user()->refresh(12, 'xml', 'http://www.rongcloud.cn/images/logo.png');
	//echo "refresh    ";
	print_r($result);
	echo "\n";
	...
	$result = $RongCloud->message()->publishPrivate(12, 13, 'RC:VcMsg',"{\"content\":\"hello\",\"extra\":\"helloExtra\",\"duration\":20}", 'thisisapush', '{\"pushData\":\"hello\"}', '4', '0', '0', '0');
	//echo "publishPrivate    ";
	print_r($result);
	//echo "\n";
