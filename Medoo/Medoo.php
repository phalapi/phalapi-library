        ...
        try {
            ...
            switch ($type)
            {
                ...
                case 'mysql':
                    if ($this->socket)
                    {
                        $dsn = $type . ':unix_socket=' . $this->socket . ';dbname=' . $this->name;
                    }
                    else
                    {
                        $dsn = $type . ':host=' . $this->host . ($is_port ? ';port=' . $port : '') . ';dbname=' . $this->name;
                    }
                ...
                case 'sybase':
                    $dsn = 'dblib:host=' . $this->host . ($is_port ? ':' . $port : '') . ';dbname=' . $this->name;
                    break;

                case 'oracle':
                    $dbname = $this->host ?
                        '//' . $this->host . ($is_port ? ':' . $port : ':1521') . '/' . $this->name :
                        $this->name;
                ...
                case 'mssql':
                    $dsn = strstr(PHP_OS, 'WIN') ?
                        'sqlsrv:server=' . $this->host . ($is_port ? ',' . $port : '') . ';database=' . $this->name :
                        'dblib:host=' . $this->host . ($is_port ? ':' . $port : '') . ';dbname=' . $this->name;
